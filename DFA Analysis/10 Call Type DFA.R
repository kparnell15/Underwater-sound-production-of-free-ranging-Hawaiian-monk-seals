...
# Load the dataset
data <- read.csv("/Users/kirby/Documents/University of Hawaii/Dissertation Chapters/Sound Production Project/Analysis/Vocal Repertoire Analysis/For manuscript/DFA analysis/DFA_18 call types.csv")
